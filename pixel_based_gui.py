...
createLabel('Hello', window)

createLabel('Hello', window)

createTextEntry("Number of Harts", window, fixed_val = '', _infobox = True, heading = 'Hello', description = 'What\'s is up', numbers_only=True)
...
createCounterField(window, 'Names bahag', 'Arial 11')
